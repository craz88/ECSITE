...
<div class="mainpart">
	...
	<div class="inputform">
		<br>	<br>	<br>	<br>	<br>	<br>	
		<label>メーカーId:<?php echo e($maker->MakerId); ?></label><br>
		<input type="hidden" name="editmakerid" value="<?php echo e($maker->MakerId); ?>"><br>
		<label>メーカー名:</label><input type="text" name="editmakername" value="<?php echo e($maker->MakerName); ?>"> 
